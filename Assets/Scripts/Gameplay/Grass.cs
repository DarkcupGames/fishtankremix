...
public class Grass : Fish
{
    ...
    void Start()
    {
        ...
        txtStatus.text = "";
        timeCount = 0f;
        GameSystem.oxygen += fishData.ADD_OXYGEN;
        GameSystem.Instance.UpdateStat();
        txtStatus.text = "+ " + fishData.ADD_OXYGEN + " oxygen!";
        GameSystem.Instance.SetTextDelay(txtStatus, "", 2f);
    ...
    void Update()
    {
        ...
        int order = (int)(-transform.position.y * GameSystem.SORT_ORDER_DEPTH);
        ...
        if (state == "hurt")
        {
            ...
            if (hp <= 0 && state != "dead")
            {
                ...
                GameSystem.Instance.DestroyDelay(go, 1f);
                Destroy(gameObject);
            }
        }
    }
    ...
    private void Produce()
    {
        ...
        GameSystem.Instance.AddMoney(amount);
        GameSystem.Instance.SetTextDelay(txtStatus, "", 1f);
    }
